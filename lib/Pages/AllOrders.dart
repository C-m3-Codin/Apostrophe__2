...
// scroll controller
  ...
  FutureBuilder<bool> ListOfOrders() {
                            ...
                            Navigator.push(
                                ...
                                MaterialPageRoute(
                                    builder: (BuildContext context) =>
                                        OrderDetails(
                                          ord: list[index],
                                          auth: widget.profile.token.toString(),
                                        )));
                          },
                          child: Padding(
                                          ...
                                          children: [
                                            Text("Name:",
                                                style: TextStyle(
                                                    ...
                                                    color: Colors.blueGrey)),
                                            Text(
                                              list[index].customerName!.length <
                                                      17
